...
const TEACHERS = [
  {
    ...
    position: 'Hiệu phó',
    gender: 'Nữ',
    qualification: 'Thạc sĩ Giáo dục Mầm non',
    role: 'BGH',
  },
  {
    ...
    position: 'Giáo viên',
    gender: 'Nữ',
    qualification: 'Đại học Sư phạm Mầm non',
    role: 'GV',
  },
  {
  ...
  },
  {
    ...
    position: 'Giáo viên',
    gender: 'Nữ',
    qualification: 'Cao đẳng Sư phạm',
    role: 'GV',
  },
  {
    full_name: 'Phạm Thị Hương',
    email: 'huongpt@edu.vn',
    position: 'Giáo viên',
    gender: 'Nữ',
    qualification: 'Đại học Sư phạm Mầm non',
    role: 'GV',
  ...
  'Nhà trẻ 1': [
    {
      ...
      dob: '2022-03-15',
      gender: 'Nam',
      parent: { full_name: 'Nguyễn Văn Toàn', relationship: 'Cha', phone: '0901234001' },
    },
    {
      full_name: 'Trần Minh Khôi',
      dob: '2022-06-20',
      gender: 'Nam',
      parent: { full_name: 'Trần Thị Phương', relationship: 'Mẹ', phone: '0901234002' },
    },
    {
      full_name: 'Lê Thị Ngọc',
      dob: '2022-01-10',
      gender: 'Nữ',
      parent: { full_name: 'Lê Văn Hải', relationship: 'Cha', phone: '0901234003' },
    },
    {
      full_name: 'Phạm Gia Huy',
      dob: '2022-08-05',
      gender: 'Nam',
      parent: { full_name: 'Phạm Thị Nhung', relationship: 'Mẹ', phone: '0901234004' },
    },
    {
      full_name: 'Hoàng Thị Mai',
      dob: '2022-11-22',
      gender: 'Nữ',
      parent: { full_name: 'Hoàng Văn Đức', relationship: 'Cha', phone: '0901234005' },
    },
  ],
  'Nhà trẻ 2': [
    {
      ...
      dob: '2022-04-18',
      gender: 'Nữ',
      parent: { full_name: 'Vũ Văn Khánh', relationship: 'Cha', phone: '0901234006' },
    },
    {
      full_name: 'Đỗ Thiên Bảo',
      dob: '2022-07-09',
      gender: 'Nam',
      parent: { full_name: 'Đỗ Thị Hoa', relationship: 'Mẹ', phone: '0901234007' },
    },
    {
      full_name: 'Ngô Kim Ngân',
      dob: '2022-02-14',
      gender: 'Nữ',
      parent: { full_name: 'Ngô Văn Bình', relationship: 'Cha', phone: '0901234008' },
    },
    {
      full_name: 'Bùi Gia Phúc',
      dob: '2022-09-30',
      gender: 'Nam',
      parent: { full_name: 'Bùi Thị Lan', relationship: 'Mẹ', phone: '0901234009' },
    },
    {
      full_name: 'Phan Thị Quỳnh',
      dob: '2022-12-01',
      gender: 'Nữ',
      parent: { full_name: 'Phan Văn Minh', relationship: 'Cha', phone: '0901234010' },
    },
  ],
  'Mầm 1': [
    {
      full_name: 'Đinh Trọng Nghĩa',
      dob: '2021-04-12',
      gender: 'Nam',
      parent: { full_name: 'Đinh Văn Sơn', relationship: 'Cha', phone: '0901234011' },
    },
    {
      full_name: 'Lý Thị Lan',
      dob: '2021-07-30',
      gender: 'Nữ',
      parent: { full_name: 'Lý Văn Tài', relationship: 'Cha', phone: '0901234012' },
    },
    {
      full_name: 'Tạ Quốc Bảo',
      dob: '2021-02-18',
      gender: 'Nam',
      parent: { full_name: 'Tạ Thị Huệ', relationship: 'Mẹ', phone: '0901234013' },
    },
    {
      full_name: 'Cao Thị Hà',
      dob: '2021-09-14',
      gender: 'Nữ',
      parent: { full_name: 'Cao Văn Hùng', relationship: 'Cha', phone: '0901234014' },
    },
    {
      full_name: 'Dương Minh Tuấn',
      dob: '2021-12-03',
      gender: 'Nam',
      parent: { full_name: 'Dương Thị Yến', relationship: 'Mẹ', phone: '0901234015' },
    },
  ],
  'Mầm 2': [
    {
      full_name: 'Trịnh Thị Trang',
      dob: '2021-05-25',
      gender: 'Nữ',
      parent: { full_name: 'Trịnh Văn Cường', relationship: 'Cha', phone: '0901234016' },
    },
    {
      full_name: 'Hà Minh Đức',
      dob: '2021-08-11',
      gender: 'Nam',
      parent: { full_name: 'Hà Thị Thu', relationship: 'Mẹ', phone: '0901234017' },
    },
    {
      full_name: 'Mai Thị Kim',
      dob: '2021-03-07',
      gender: 'Nữ',
      parent: { full_name: 'Mai Văn Long', relationship: 'Cha', phone: '0901234018' },
    },
    {
      full_name: 'Lưu Văn Dũng',
      dob: '2021-10-19',
      gender: 'Nam',
      parent: { full_name: 'Lưu Thị Hồng', relationship: 'Mẹ', phone: '0901234019' },
    },
    {
      full_name: 'Đào Thị Phương',
      dob: '2021-01-28',
      gender: 'Nữ',
      parent: { full_name: 'Đào Văn Tuấn', relationship: 'Cha', phone: '0901234020' },
    },
  ],
  'Chồi 1': [
    {
      full_name: 'Nguyễn Quốc Hải',
      dob: '2020-06-14',
      gender: 'Nam',
      parent: { full_name: 'Nguyễn Văn Hiếu', relationship: 'Cha', phone: '0901234021' },
    },
    {
      full_name: 'Trần Thị Thu',
      dob: '2020-09-22',
      gender: 'Nữ',
      parent: { full_name: 'Trần Văn Phúc', relationship: 'Cha', phone: '0901234022' },
    },
    {
      full_name: 'Lê Văn Bình',
      dob: '2020-04-08',
      gender: 'Nam',
      parent: { full_name: 'Lê Thị Diệu', relationship: 'Mẹ', phone: '0901234023' },
    },
    {
      full_name: 'Phạm Thị Thảo',
      dob: '2020-11-30',
      gender: 'Nữ',
      parent: { full_name: 'Phạm Văn Khải', relationship: 'Cha', phone: '0901234024' },
    },
    {
      full_name: 'Hoàng Minh Hiếu',
      dob: '2020-02-15',
      gender: 'Nam',
      parent: { full_name: 'Hoàng Thị Linh', relationship: 'Mẹ', phone: '0901234025' },
    },
  ],
  'Chồi 2': [
    {
      ...
      dob: '2020-07-20',
      gender: 'Nữ',
      parent: { full_name: 'Vũ Văn Dũng', relationship: 'Cha', phone: '0901234026' },
    },
    {
      full_name: 'Đỗ Hữu Nghĩa',
      dob: '2020-10-05',
      gender: 'Nam',
      parent: { full_name: 'Đỗ Thị Nga', relationship: 'Mẹ', phone: '0901234027' },
    },
    {
      full_name: 'Ngô Thị Hà',
      dob: '2020-03-17',
      gender: 'Nữ',
      parent: { full_name: 'Ngô Văn Nam', relationship: 'Cha', phone: '0901234028' },
    },
    {
      full_name: 'Bùi Văn Thắng',
      dob: '2020-08-29',
      gender: 'Nam',
      parent: { full_name: 'Bùi Thị Mai', relationship: 'Mẹ', phone: '0901234029' },
    },
    {
      full_name: 'Phan Thị Ngọc',
      dob: '2020-12-11',
      gender: 'Nữ',
      parent: { full_name: 'Phan Văn Hùng', relationship: 'Cha', phone: '0901234030' },
    },
  ],
  'Lá 1': [
    {
      full_name: 'Đinh Văn Toàn',
      dob: '2019-05-02',
      gender: 'Nam',
      parent: { full_name: 'Đinh Thị Lan', relationship: 'Mẹ', phone: '0901234031' },
    },
    {
      full_name: 'Lý Thị Hương',
      dob: '2019-08-18',
      gender: 'Nữ',
      parent: { full_name: 'Lý Văn Tùng', relationship: 'Cha', phone: '0901234032' },
    },
    {
      full_name: 'Tạ Minh Khoa',
      dob: '2019-03-25',
      gender: 'Nam',
      parent: { full_name: 'Tạ Thị Vân', relationship: 'Mẹ', phone: '0901234033' },
    },
    {
      full_name: 'Cao Thị Linh',
      dob: '2019-10-07',
      gender: 'Nữ',
      parent: { full_name: 'Cao Văn Sáng', relationship: 'Cha', phone: '0901234034' },
    },
    {
      full_name: 'Dương Văn Khải',
      dob: '2019-01-14',
      gender: 'Nam',
      parent: { full_name: 'Dương Thị Hoa', relationship: 'Mẹ', phone: '0901234035' },
    },
  ],
  'Lá 2': [
    {
      ...
      dob: '2019-06-11',
      gender: 'Nữ',
      parent: { full_name: 'Trịnh Văn Tài', relationship: 'Cha', phone: '0901234036' },
    },
    {
      full_name: 'Hà Quốc Tuấn',
      dob: '2019-09-03',
      gender: 'Nam',
      parent: { full_name: 'Hà Thị Xuân', relationship: 'Mẹ', phone: '0901234037' },
    },
    {
      full_name: 'Mai Thị Phúc',
      dob: '2019-04-22',
      gender: 'Nữ',
      parent: { full_name: 'Mai Văn Bảo', relationship: 'Cha', phone: '0901234038' },
    },
    {
      full_name: 'Lưu Văn Hải',
      dob: '2019-11-16',
      gender: 'Nam',
      parent: { full_name: 'Lưu Thị Thu', relationship: 'Mẹ', phone: '0901234039' },
    },
    {
      full_name: 'Đào Thị Trang',
      dob: '2019-02-08',
      gender: 'Nữ',
      parent: { full_name: 'Đào Văn Minh', relationship: 'Cha', phone: '0901234040' },
    },
  ],
};
...
async function main() {
  ...
  const [bghRole, gvRole] = await Promise.all([
    prisma.role.upsert({
      where: { role_name: 'BGH' },
      update: {},
      create: { role_name: 'BGH', description: 'Ban Giám Hiệu' },
    }),
    prisma.role.upsert({
      where: { role_name: 'GV' },
      update: {},
      create: { role_name: 'GV', description: 'Giáo viên' },
    }),
  ]);
  ...
  for (const c of existingClasses) {
    await prisma.studentEnrollment.deleteMany({ where: { class_id: c.class_id } });
  ...
  for (const yr of YEARS) {
    ...
    for (const sem of yr.semesters) {
      await prisma.semester.upsert({
        where: {
          school_year_id_semester_number: {
      ...
      if (!enrolled) {
        await prisma.studentEnrollment.create({
          data: {
            ...
            enrolled_date: new Date('2024-09-01'),
          },
        });
      }

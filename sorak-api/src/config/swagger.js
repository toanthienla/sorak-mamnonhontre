...
const definition = {
  ...
  components: {
    ...
    schemas: {
      ...
      ParentLoginRequest: {
        type: 'object',
        required: ['student_id_card_number', 'password'],
        properties: {
      ...
      UserInfo: {
        ...
        properties: {
          ...
          role: { type: 'string', enum: ['PRINCIPAL', 'TEACHER', 'PARENT'] },
        },
      },
      // ── Teacher ───────────────────────────────────────────────────────────
      Teacher: {
      ...
      CreateTeacher: {
        type: 'object',
        required: ['full_name', 'email', 'position'],
        properties: {
          full_name: { type: 'string' },
  ...
  paths: {
    ...
    '/auth/parent-login': {
      post: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/ParentLoginRequest' } },
          },
        },
    ...
    '/auth/forgot-password': {
      post: {
        tags: ['Auth'],
        summary: 'Gửi OTP quên mật khẩu (BGH/GV)',
        security: [],
    ...
    '/teachers': {
      get: {
        ...
        parameters: [
          ...
          { in: 'query', name: 'search', schema: { type: 'string' } },
          {
            in: 'query',
            name: 'role',
            schema: { type: 'string', enum: ['PRINCIPAL', 'TEACHER', 'none'] },
          },
      ...
      post: {
        tags: ['Teachers'],
        summary: 'Tạo cán bộ mới (BGH)',
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/CreateTeacher' } },
          },
        },
    ...
    '/teachers/{id}': {
      get: {
        tags: ['Teachers'],
        summary: 'Chi tiết cán bộ',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Teacher detail' } },
      },
      patch: {
        tags: ['Teachers'],
        summary: 'Cập nhật cán bộ (BGH)',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
        requestBody: {
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/CreateTeacher' } },
    ...
    '/accounts/{id}/assign-role': {
      post: {
        tags: ['Accounts'],
        summary: 'Cấp role + mật khẩu cho cán bộ (BGH)',
        parameters: [
          {
            in: 'path',
            name: 'id',
    ...
    '/accounts/{id}/active': {
      patch: {
        tags: ['Accounts'],
        summary: 'Khóa/mở khóa tài khoản (BGH)',
        parameters: [
          {
            in: 'path',
            name: 'id',
    ...
    '/academic-years': {
      get: {
        tags: ['Academic Years'],
        summary: 'Danh sách năm học',
        responses: { 200: { description: 'List school years' } },
      },
      post: {
        tags: ['Academic Years'],
        summary: 'Tạo năm học mới (BGH)',
        requestBody: {
    ...
    '/academic-years/{id}': {
      get: {
        tags: ['Academic Years'],
        summary: 'Chi tiết năm học',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Detail' } },
      },
      patch: {
        tags: ['Academic Years'],
        summary: 'Cập nhật năm học (BGH)',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Updated' } },
      },
      delete: {
        tags: ['Academic Years'],
        summary: 'Xóa mềm năm học (BGH)',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
    ...
    '/academic-years/{id}/activate': {
      patch: {
        tags: ['Academic Years'],
        summary: 'Activate năm học → promote students (BGH)',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
    ...
    '/academic-years/{id}/promote': {
      post: {
        tags: ['Academic Years'],
        summary: 'Promote học sinh thủ công (BGH)',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
    ...
    '/classes/{id}': {
      ...
      patch: {
        tags: ['Classes'],
        summary: 'Cập nhật lớp (BGH)',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Updated' } },
      },
      delete: {
        tags: ['Classes'],
        summary: 'Lưu trữ lớp (BGH)',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
    ...
    '/students': {
      ...
      post: {
        tags: ['Students'],
        summary: 'Tạo hồ sơ học sinh (BGH)',
        requestBody: {
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/CreateStudent' } },
          },
        },
        responses: { 200: { description: 'Created' } },
      },
    ...
    '/students/{id}': {
      get: {
        tags: ['Students'],
        summary: 'Chi tiết học sinh',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Detail' } },
      },
      patch: {
        tags: ['Students'],
        summary: 'Cập nhật hồ sơ học sinh (BGH)',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Updated' } },
      },
      delete: {
        tags: ['Students'],
        summary: 'Lưu trữ học sinh (BGH)',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Archived' } },
      },
    },
    ...
    '/students/{id}/parents': {
      post: {
        tags: ['Students'],
        summary: 'Thêm phụ huynh cho học sinh',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Parent added' } },
      },
    },
    '/students/parents/{parentId}': {
      patch: {
        tags: ['Students'],
        summary: 'Cập nhật phụ huynh',
        parameters: [{ in: 'path', name: 'parentId', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Updated' } },
      },
    },
    '/students/{id}/photo': {
      post: {
        ...
        responses: { 200: { description: 'Photo URL' } },
      },
    },
    '/students/{id}/active': {
      patch: {
        tags: ['Students'],
        summary: 'Khóa/mở tài khoản PH',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Updated' } },
      },
    },
    '/students/{id}/reset-password': {
      post: {
        tags: ['Students'],
        summary: 'Reset mật khẩu PH về mặc định',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' } }],
